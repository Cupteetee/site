...
var flb_settings = $.extend({
        ...
        lightbox_text_style: 'font-size: 14px; line-height: 1.4; color: #F3F1F5; text-align: center;',
        
        lightbox_text_anchor_link_style: 'text-decoration: underline; color: #F3F1F5;',
    
        lightbox_text_background_style: 'background-color: #463572; opacity:0.8;',
        ...
        next_and_back_image_text_style: 'font-weight: bold; color: #F3F1F5;',
    
        image_number_page: 'Фотогрфия',
    
        image_number_of: 'из',
    
        image_number_text_style: 'color: #F3F1F5;',
